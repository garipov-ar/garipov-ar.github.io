...
const CASES: CaseProject[] = [
  ...
  {
    id: 'car-site',
    title: 'NORD AUTO IMPORT — Авто из Китая, Кореи, Японии и Европы',
    subtitle: 'Таможенный калькулятор 2026, каталог и онлайн-трекинг',
    category: 'web',
    categoryLabel: 'Сайты для бизнеса',
    isFeatured: true,
    featuredBadge: '★ NEW • AUTOMOTIVE & CUSTOMS CALC',
    description: 'Премиальный веб-сервис прямого импорта автомобилей из Китая, Кореи, Японии и Европы с интерактивным таможенным калькулятором по ставкам 2025/2026 года, каталогом автомобилей, умным 4-шаговым квизом и симулятором трекинга заказа по VIN.',
    challenge: 'Клиентам, заказывающим автомобили из-за рубежа, сложно рассчитать полную стоимость со всеми расходами (пошлина, утильсбор, фрахт, СБКТС/ЭПТС), а также они опасаются серых схем и отсутствия прозрачного контроля логистики.',
    solution: 'Разработан современный сервис на Next.js 15: математический движок расчета пошлин и утильсбора РФ с прозрачной разбивкой и демонстрацией чистой экономии до 35%, интерактивный каталог с инспекцией 140 пунктов, умный квиз и симулятор отслеживания статуса авто по VIN.',
    results: [
      'Интерактивный таможенный калькулятор с детальной сметой и выгрузкой КП',
      'Каталог с фильтрацией по 4 странам (Китай, Корея, Япония, Европа) и типам кузова',
      'Симулятор онлайн-трекинга движения автомобиля по номеру договора/VIN'
    ],
    keyFeatures: [
      'Таможенный калькулятор 2025/2026 (пошлины ФТС, утильсбор для физлиц, фрахт, ЭПТС)',
      'Сравнение стоимости "под ключ" в РФ с рыночными ценами на Авто.ру',
      'Умный 4-шаговый квиз подбора авто за 60 секунд с фиксацией персональной скидки',
      'Симулятор трекинга заказа (контрольные точки: выкуп, паром, таможня, автовоз)',
      'Полноэкранные карточки авто с отчетом инспекции 140 пунктов и фотогалереей'
    ],
    architectureSteps: [
      { label: 'КЛИЕНТ', sub: 'Калькулятор & Квиз', color: '#F43F5E' },
      { label: 'CUSTOMS ENGINE', sub: 'Тарифы ФТС & Утильсбор', color: '#38BDF8' },
      { label: 'CATALOG & VIN', sub: 'Live Tracking System', color: '#10B981' },
      { label: 'TELEGRAM & КП', sub: 'Заявки & PDF-сметы', color: '#229ED9' }
    ],
    stack: ['Next.js 15', 'React 19', 'TypeScript', 'Customs Math Engine', 'Lucide React', 'CSS Modules'],
    demoUrl: 'https://garipov-ar.github.io/car-site/',
    githubUrl: 'https://github.com/garipov-ar/car-site',
